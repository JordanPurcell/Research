      ...
      open(unit=20,file='m8r.dat')
      open(unit=21,file='m8t.dat')         
      open(unit=30,file='q8r.dat')
      open(unit=31,file='q8t.dat')  
...
330   format(i2) 
      ...
      name1 = 'c:\rsh-nushellx\n50\b35\'//name//'.deo'  
      name2 = 'c:\rsh-nushellx\n50\a35\'//name//'.deo'        
...
c      read(b100,*) x1,x2,x3,x4,x5t
      ...
      xa = ia
      write(20,120) xa,x3r
      write(21,120) xa+0.2,x3t  
      write(30,120) xa,x4r
      write(31,120) xa+0.2,x4t             
